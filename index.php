...
.des {
display: block;
background-color: lightblue; width: 40%;
}
</style>
</head>
<h1>
...
case "usr":
if (empty($value))
$error["usr"] = "*Name cannot be left blank!"; break;

case "email":
if (!filter_var($value, FILTER_VALIDATE_EMAIL))
$error["email"] = "*Email cannot be left blank!"; break;
case "edu":
if ($value == "--")
$error["edu"] = "*Tell us about your education!"; break;

case "comment":
if ($value=="")
$error["comment"] = "*This field is required."; break;
}
}
